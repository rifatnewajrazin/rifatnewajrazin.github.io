...
(function () {
  ...
  /* ---------- route matching ----------
     ...
     domain root or under /redesign2/, and both locally and in production. */
  ...
  // The URL shown in the address bar (bare "/redesign2/") can differ from
  // what we actually fetch: relying on a host's directory-index behaviour
  // to resolve "/redesign2/" to its index.html is one more thing that can
  ...
  (function wireRouterLinks() {
    document.addEventListener('click', function (e) {
      ...
      // link to "/redesign2/" and a cold load at "/redesign2/index.html" are
  ...
  function renderWorkGrid() {
    ...
    return fetch('/redesign2/data/work.json', { cache: 'no-store' })
      ...
      .then(function (data) {
        ...
        items.forEach(function (item, i) {
          ...
          a.href = '/redesign2/work/case.html?slug=' + encodeURIComponent(item.slug || '');
  ...
  function renderVersions() {
    ...
    return fetch('/redesign2/data/versions.json', { cache: 'no-store' })
      .then(function (r) { return r.ok ? r.json() : null; })
      .catch(function () { return null; })
      .then(function (data) {
  ...
  function renderStatement() {
    ...
    return fetch('/redesign2/data/statement.json', { cache: 'no-store' })
      .then(function (r) { return r.ok ? r.json() : null; })
      .catch(function () { return null; })
      .then(function (data) {
    ...
    return fetch('/redesign2/data/work.json', { cache: 'no-store' })
      ...
      .then(function (data) {
        ...
        if (nextLink) {
          ...
          nextLink.href = '/redesign2/work/case.html?slug=' + encodeURIComponent(next.slug || '');
        }
      })
  ...
  function initFloaties() {
    ...
    /* Hand-drawn-ish doodles as inline SVG (crisp, themeable via
       ...
       instead, drop a transparent PNG in /redesign2/uploads/ and change
    ...
    //   { type:"image",   src:"/redesign2/uploads/x.svg", x:50, y:20, width:90 }
    ...
    return fetch('/redesign2/data/floaties.json', { cache: 'no-store' })
      .then(function (r) { return r.ok ? r.json() : null; })
      .catch(function () { return null; })
      .then(function (data) {
